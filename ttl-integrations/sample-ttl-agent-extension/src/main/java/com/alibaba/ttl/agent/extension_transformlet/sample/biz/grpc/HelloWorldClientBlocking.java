 ...
 */
public class HelloWorldClientBlocking {
  private static final Logger logger = Logger.getLogger(HelloWorldClientBlocking.class.getName());

  private final com.alibaba.ttl.agent.extension_transformlet.sample.biz.grpc.GreeterGrpc.GreeterBlockingStub blockingStub;

  /** Construct client for accessing HelloWorld server using the existing channel. */
  public HelloWorldClientBlocking(Channel channel) {
    // 'channel' here is a Channel, not a ManagedChannel, so it is not this code's responsibility to
    // shut it down.

    // Passing Channels to code makes code easier to test and makes it easier to reuse Channels.
    blockingStub = com.alibaba.ttl.agent.extension_transformlet.sample.biz.grpc.GreeterGrpc.newBlockingStub(channel);
  }
